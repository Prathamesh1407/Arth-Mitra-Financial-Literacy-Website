...
//   return (
//     <div className="flex mt-5 justify-center items-center h-screen">
...
//           <button onClick={calculateResult} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
//             Calculate
//           </button>
//         </div>
//         <div className="mt-8">
//           <div className="text-gray-700 text-2xl font-bold mb-2">Results:</div>
